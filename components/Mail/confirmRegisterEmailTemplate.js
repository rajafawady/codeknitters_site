// emailTemplate.js
const createConfirmationMessage = (link) => {
  const body = `
        
     
          <p>Thank you for registering with us! We are excited to have you as part of our community. Stay tuned for updates on our latest products and services.</p>
                      ...
                      <tr>
                          <td style="text-align:center; padding: 0 40px;">
                            <a href="javascript:void(0)" title="logo" target="_blank">
                              <img width="173px" height="30px" src="cid:logo" alt="">
                            </a>
                          </td>
                      </tr>
                      <tr>
                              ...
                              <table width="600px" border="0" align="center" cellpadding="0" cellspacing="0"
                                  ...
                                  <tr>
                                      <td style="text-align:center;">
                                        <a href="${link}" style="color:#fff; font-size:15px;line-height:18px; margin:0; padding: 10px 20px; background: #0098E9; border: 1px solid #DEDEE8; border-radius: 12px; font-family:'Rubik',sans-serif;">
                                          Verify Email
                                        </a>
                                      </td>
                                  </tr>
                                  ...
                                  <tr>
                                      ...
                                      <hr style="width: 100%; height: 0.01rem; margin-bottom: 15px; background-color:#0000001a;"></hr>
                                        <p style="color:#999999; font-size:14px;line-height:24px; margin:0 0 15px 0;">Need help? Contact our support team .Want to give us feedback? Let us know what you think on our feedback site.</p>
                                        <p style="color:#999999; font-size:14px;line-height:24px; margin:0;">Copyright © 2023</p>
                                      </td>
                                  </tr>
                                  <tr>
                                      <td style="height:20px;">&nbsp;</td>
